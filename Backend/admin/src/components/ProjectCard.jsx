...
function ProjectCard({ projectName, projectStatus, creationDate, deadline }) {
  ...
  return (
    <div className="h-20 w-auto m-5 p-3 pr-4 pl-4 border flex justify-between items-center bg-blue-300 rounded-lg cursor-pointer hover:bg-blue-500 transition-colors duration-300">
